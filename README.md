...
- Core modelling assumptions, numerical defaults, and scenario grids are defined in `params.jl`.
- Detailed provenance and interpretation of parameters and datasets are documented in `PARAMETER_AND_DATA_AUDIT.md`.
- For source verification, unresolved provenance items, and assumption tracking, consult `PARAMETER_AND_DATA_AUDIT.md` before using results in publication.
